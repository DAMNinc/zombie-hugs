...
Terrain.prototype.getMesh = function() {
	data = generateHeight( terrainWidth, terrainHeight );
	...
	texture = new THREE.Texture(generateTexture(data), THREE.UVMapping, THREE.ClampToEdgeWrapping, THREE.ClampToEdgeWrapping);
